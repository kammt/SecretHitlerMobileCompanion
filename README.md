...
This app is based on the board game Secret Hitler. However, do keep in mind that this app is not intended to replace the game but rather extend on it to make the board game experience easier and more fun for all players. 
